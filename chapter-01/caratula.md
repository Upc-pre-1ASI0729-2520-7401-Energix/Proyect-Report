...
| 0.4.8   | 03/11/2025 | Iker Barturen   | Creación del repositorio Back-SEMS y organización del proyecto.                                                                            |
| 0.4.9   | 09/11/2025 | Alexis Encalada | Implementación del endpoint de configuración                                                                                               |
| 0.5.0   | 13/11/2025 | Yeira Huaman    | Implementación del endpoint de perfil                                                                                                      |
| 0.5.1   | 14/11/2025 | Andrés Torres   | Implementación del endpoint de reportes                                                                                                    |
...
![ContributorsFT.png](assets/ContributorsFT.png)

Commits del equipo:

![Commits5.png](assets/Commits5.png)
![Commits4.png](assets/Commits4.png)
![Commits3.png](assets/Commits3.png)
![Commits2.png](assets/Commits2.png)
![Commits1.png](assets/Commits1.png)
...
![ContributorsBK.png](assets/ContributorsBK.png)

Commits del equipo:

![CommitsBK4.png](assets/CommitsBK4.png)
![CommitsBK3.png](assets/CommitsBK3.png)
...
| Comunica oralmente con efectividad a diferentes rangos de audiencia.    | TB2: Mateo Loeche: Dirigí presentaciones técnicas del backend, explicando integración frontend–backend y despliegue.                                                                                                                                                                                                                                                                                                                                             | Durante las distintas etapas de los proyectos (TB1, TP1 y TB2), el equipo demostró una evolución notable en su capacidad de comunicar oralmente de manera efectiva, adaptándose al tipo de audiencia —desde usuarios finales hasta stakeholders técnicos—. En cada presentación se empleó un lenguaje adecuado al nivel de conocimiento requerido, asegurando claridad en conceptos complejos, especialmente durante la explicación de arquitecturas, flujos de trabajo y despliegues                                                                                                                                                    |
| Comunica por escrito con efectividad a diferentes rangos de audiencia.  | TB2: Mateo Loeche: Redactó documentación técnica de despliegue, producción y rendimiento del backend.                                                                                                                                                                                                                                                                                                                                                            | La documentación generada en las diferentes fases del proyecto refleja un dominio sólido de la comunicación escrita profesional. El equipo elaboró informes técnicos, manuales, guías, análisis funcionales y documentación de despliegue con claridad, estructura y coherencia. Se logró adaptar el nivel de tecnicidad según la audiencia prevista, asegurando que tanto desarrolladores como stakeholders no técnicos pudieran comprender la información presentada                                                                                                                                                                   |
| Comunica oralmente con efectividad a diferentes rangos de audiencia.    | TB2: Iker Barturen: Explicó arquitectura backend, autenticación y gestión de dispositivos para distintos tipos de audiencia.                                                                                                                                                                                                                                                                                                                                     | Durante las distintas etapas de los proyectos (TB1, TP1 y TB2), el equipo demostró una evolución notable en su capacidad de comunicar oralmente de manera efectiva, adaptándose al tipo de audiencia —desde usuarios finales hasta stakeholders técnicos—. En cada presentación se empleó un lenguaje adecuado al nivel de conocimiento requerido, asegurando claridad en conceptos complejos, especialmente durante la explicación de arquitecturas, flujos de trabajo y despliegues                                                                                                                                                    |
| Comunica por escrito con efectividad a diferentes rangos de audiencia.  | TB2: Iker Barturen:  Documentó configuración de entorno, APIs, despliegue y evidencias del Sprint.                                                                                                                                                                                                                                                                                                                                                               | La documentación generada en las diferentes fases del proyecto refleja un dominio sólido de la comunicación escrita profesional. El equipo elaboró informes técnicos, manuales, guías, análisis funcionales y documentación de despliegue con claridad, estructura y coherencia. Se logró adaptar el nivel de tecnicidad según la audiencia prevista, asegurando que tanto desarrolladores como stakeholders no técnicos pudieran comprender la información presentada                                                                                                                                                                   |
| Comunica oralmente con efectividad a diferentes rangos de audiencia.    | TB2: Yeira Huaman: Explicó la integración de perfiles de usuario con autenticación en backend y mejoras de experiencia.                                                                                                                                                                                                                                                                                                                                          | Durante las distintas etapas de los proyectos (TB1, TP1 y TB2), el equipo demostró una evolución notable en su capacidad de comunicar oralmente de manera efectiva, adaptándose al tipo de audiencia —desde usuarios finales hasta stakeholders técnicos—. En cada presentación se empleó un lenguaje adecuado al nivel de conocimiento requerido, asegurando claridad en conceptos complejos, especialmente durante la explicación de arquitecturas, flujos de trabajo y despliegues                                                                                                                                                    |
| Comunica por escrito con efectividad a diferentes rangos de audiencia   | TB2: Yeira Huaman: Elaboró guías de usuario, manuales técnicos y reportes de testing del backend.                                                                                                                                                                                                                                                                                                                                                                | La documentación generada en las diferentes fases del proyecto refleja un dominio sólido de la comunicación escrita profesional. El equipo elaboró informes técnicos, manuales, guías, análisis funcionales y documentación de despliegue con claridad, estructura y coherencia. Se logró adaptar el nivel de tecnicidad según la audiencia prevista, asegurando que tanto desarrolladores como stakeholders no técnicos pudieran comprender la información presentada                                                                                                                                                                   |
| Comunica oralmente con efectividad a diferentes rangos de audiencia.    | TB2: Andrés Torres: Presentó la funcionalidad de reportes y su integración con la API backend.                                                                                                                                                                                                                                                                                                                                                                   | Durante las distintas etapas de los proyectos (TB1, TP1 y TB2), el equipo demostró una evolución notable en su capacidad de comunicar oralmente de manera efectiva, adaptándose al tipo de audiencia —desde usuarios finales hasta stakeholders técnicos—. En cada presentación se empleó un lenguaje adecuado al nivel de conocimiento requerido, asegurando claridad en conceptos complejos, especialmente durante la explicación de arquitecturas, flujos de trabajo y despliegues                                                                                                                                                    |
